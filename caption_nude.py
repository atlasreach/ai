#!/usr/bin/env python3
"""Caption and Rank Nude/Artistic Images"""
...
Analyze this NUDE image and create a detailed training caption following this EXACT format:

Milan, [skin tone], [hair color and style], [facial features], nude, [body features], [pose/action], [body orientation], [expression - REQUIRED!], [camera angle], [background/location], [lighting], nsfw

IMPORTANT GUIDELINES:
1. Start with "Milan" as the trigger word
2. Always include "nude" in the caption
3. BODY FEATURES - Be specific:
   - Breasts: small breasts, medium breasts, large breasts, perky breasts, natural breasts
   - Body type: athletic, curvy, slim, toned, thick thighs, wide hips, flat stomach, etc.
   - What's visible: full body nude, topless, pussy visible, ass visible, spread legs, etc.
4. BODY ORIENTATION - Where is her body facing vs head:
   - "ass facing camera, looking back over shoulder"
   - "lying on back, legs spread"
   - "on all fours, back arched"
...
6. Hand/arm position: hands on hips, covering breasts, touching pussy, hands behind head, arms raised, etc.
7. EXPRESSION - ALWAYS INCLUDE:
   - Smiling, playful smile, naughty grin, seductive look, sultry expression
   - Biting lip, mouth open, eyes closed, looking at camera, shy look
   - Confident, inviting, teasing, innocent look, bedroom eyes
8. Camera angle: front view, back view, side view, 3/4 view, POV, low angle, close-up, full body
9. Background & lighting
10. Keep detailed (one line)
11. End with "nsfw"

ALSO provide a quality score (0-100) based on:
- Image sharpness and clarity (30 points)
- Lighting quality (20 points)
- Pose variety and artistic appeal (20 points)
...
def main():
    print("🎨 NUDE/ARTISTIC Caption Tool")
    print("="*80)

    image_dir = Path("/workspaces/ai/models_2.0/milan/nude")
    ranking_file = image_dir.parent / "nude_ranking.json"

    all_images = sorted([f for f in image_dir.glob("milan_nude_*")])
    if not all_images:
    ...
    print_summary(all_results, "NUDE")
