        ...
        >
          ...
          >
            <div className="p-6">
              ...
              {lightboxJob.reference_filename && (
                <div className="mb-6">
                  <h3 className="text-lg font-semibold mb-2">Reference Image</h3>
                  <div className="flex gap-4">
                    <img
                      src={`${SUPABASE_URL}/storage/v1/object/public/reference-images/${lightboxJob.reference_filename}`}
                      alt="Reference"
                      className="w-64 h-64 object-cover rounded-lg"
                    />
                    {lightboxJob.reference_caption && (
                      <div className="flex-1 bg-gray-800 p-4 rounded-lg">
                        <h4 className="text-sm font-semibold mb-2 text-gray-400">Grok Vision Caption</h4>
                        <p className="text-sm text-gray-300">{lightboxJob.reference_caption}</p>
                      </div>
                    )}
                  </div>
                </div>
